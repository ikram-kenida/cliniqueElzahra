...
import { faHandHoldingDroplet, faHeart, faHeartCircleBolt, faMicrochip, faPlay, faUserDoctor } from "@fortawesome/free-solid-svg-icons";
function WhyChooseUs(){
    return(
        <>
      <div className="container-fluid whyChooseUs mt-5">
  ...
  <div className=" row mt-5 p-md-5  justify-content-center align-items-center mx-md-5  m-0 ">
        ...
        <div className="row whys m-0">
             <div className="why  align-items-center col-md-5 col-12 p-4 mx-md-2">
...
>
  ...
  <div className="textimg p-4 col-md-7">
